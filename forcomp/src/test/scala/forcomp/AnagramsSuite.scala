...
class AnagramsSuite extends FunSuite  {
  ...
  test("sentenceOccurrences: abcd bad") {
    assert(sentenceOccurrences(List("abcd", "bad")) === List(('a', 2), ('b', 2), ('c', 1), ('d', 2)))
  }
